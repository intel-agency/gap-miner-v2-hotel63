...
| **Target repo** | `intel-agency/gap-miner-v2-hotel63` (a GitHub **template** repo) |
| **Status** | Active |
| **Date** | 2026-07-18 |
...
`gap-miner-v2-hotel63` is a **generic GitHub template repo**. It is not an application —
...
- `.agents/memory.md` — Current Activity / Completed Work / Decisions describe
  *gap-miner-v2-hotel63's own* development, not the clone's app.
- This repo's own `docs/plans/.completed/*` — e.g.
  `gap-miner-v2-hotel63-fix-plan.md`, `app-stacks-rules-plan.md`,
